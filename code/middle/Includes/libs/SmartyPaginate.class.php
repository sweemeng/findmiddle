     ...
     */
     function  reset($id = 'default') {
        $_SESSION['SmartyPaginate'][$id] = array(
            ...
            'prev_text' => '<img height="15" border="0" width="18" src="images/left.gif" alt="Previous" />',
            'next_text' => '<img height="15" border="0" width="18" src="images/right.gif" alt="Next" />',
            'first_text' => '<img height="15" border="0" width="18" src="images/icon_previous2.gif" alt="First" />',
            'last_text' => '<img height="15" border="0" width="18" src="images/icon_next2.gif" alt="Last" />'
            );
        // Original prev_text => Back
        // Original next_text => Next
    }
